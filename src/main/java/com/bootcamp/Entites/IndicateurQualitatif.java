...
public class IndicateurQualitatif implements Serializable {
    ...
    public IndicateurQualitatif(long id, String nom, String propriete, String valeur) {
        this.id = id;
        this.nom = nom;
    ...
    public IndicateurQualitatif(String nom, String propriete, String valeur) {
        this.nom = nom;
        this.propriete = propriete;
        this.valeur = valeur;
    }
    ...
    public String toString() {
        return "com.bootcamp.Entites.IndicateurQualitatif[ id=" + id + " ]";
    }
}
