...
// */
//package com.bootcamp.TestDerby;
//
...
// * @author Bello
// */
//public class TestBeneficiaireDerby {
//    
//    public TestBeneficiaireDerby() {
//    }
//
//    /**
...
//        
//        BaseControlleur<Programme_has_Beneficiaire> instancebp = new BaseControlleur<>("TP_JPA_PU_2", Programme_has_Beneficiaire.class);
//        BaseControlleur<Beneficiaire> instanceb = new BaseControlleur<>("TP_JPA_PU_2", Beneficiaire.class);
//        BaseControlleur<Programme> instancep = new BaseControlleur<>("TP_JPA_PU_2", Programme.class);
//        
//        List expResult = null;
...
//        
//        List result = new BeneficiaireControlleur().getAllBeneficiaireByProgramme(p1, "TP_JPA_PU_2");
//        if (result!=expResult) {
...
//        
//        BaseControlleur<Beneficiaire_has_Projet> instancebp = new BaseControlleur<>("TP_JPA_PU_2", Beneficiaire_has_Projet.class);
//        BaseControlleur<Beneficiaire> instanceb = new BaseControlleur<>("TP_JPA_PU_2", Beneficiaire.class);
//        BaseControlleur<Projet> instancep = new BaseControlleur<>("TP_JPA_PU_2", Projet.class);
//        
//        List expResult = null;
//        Beneficiaire b1 = new Beneficiaire(1,"Marley");
//        Beneficiaire b3 = new Beneficiaire(2,"Dupont");
...
//        instancebp.create(bp1); instancebp.create(bp2); instancebp.create(bp3); instancebp.create(bp4); instancebp.create(bp4); instancebp.create(bp5); instancebp.create(bp6); instancebp.create(bp7);
//        
//        List result = new BeneficiaireControlleur().getAllBeneficiaireByProjet(p1, "TP_JPA_PU_2");
//        if (result!=expResult) {
