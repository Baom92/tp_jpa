...
// * @author Bello
// */
//public class TestFournisseurDerby {
//    
//    public TestFournisseurDerby() {
//    }
//
//    /**
...
//        
//        BaseControlleur<Programme_has_Fournisseur> instancebp = new BaseControlleur<>("TP_JPA_PU_2", Programme_has_Fournisseur.class);
//        BaseControlleur<Fournisseur> instanceb = new BaseControlleur<>("TP_JPA_PU_2", Fournisseur.class);
...
//        
//        List result = new FournisseurControlleur().getAllFournisseurByProgramme(p1, "TP_JPA_PU_2");
//        if (result!=expResult) {
...
//        
//        BaseControlleur<Projet_has_Fournisseur> instancebp = new BaseControlleur<>("TP_JPA_PU_2", Projet_has_Fournisseur.class);
//        BaseControlleur<Fournisseur> instanceb = new BaseControlleur<>("TP_JPA_PU_2", Fournisseur.class);
...
//        instancebp.create(bp1); instancebp.create(bp2); instancebp.create(bp3); instancebp.create(bp4); instancebp.create(bp4); instancebp.create(bp5); instancebp.create(bp6); instancebp.create(bp7);
//        
//        List result = new FournisseurControlleur().getAllFournisseurByProjet(p1, "TP_JPA_PU_2");
//        if (result!=expResult) {
