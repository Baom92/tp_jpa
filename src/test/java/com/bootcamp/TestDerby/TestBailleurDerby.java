...
// * @author Bello
// */
//public class TestBailleurDerby {
//    
//    public TestBailleurDerby() {
//    }
//
//    /**
...
//        
//        BaseControlleur<Bailleur_has_Programme> instancebp = new BaseControlleur<>("TP_JPA_PU_2", Bailleur_has_Programme.class);
//        BaseControlleur<Bailleur> instanceb = new BaseControlleur<>("TP_JPA_PU_2", Bailleur.class);
...
//        
//        List result = new BailleurControlleur().getAllBailleurByProgramme(p1, "TP_JPA_PU_2");
//        if (result!=expResult) {
...
//        
//        BaseControlleur<Bailleur_has_Projet> instancebp = new BaseControlleur<>("TP_JPA_PU_2", Bailleur_has_Projet.class);
//        BaseControlleur<Bailleur> instanceb = new BaseControlleur<>("TP_JPA_PU_2", Bailleur.class);
...
//        instancebp.create(bp1); instancebp.create(bp2); instancebp.create(bp3); instancebp.create(bp4); instancebp.create(bp4); instancebp.create(bp5); instancebp.create(bp6); instancebp.create(bp7);
//        
//        List result = new BailleurControlleur().getAllBailleurByProjet(p1, "TP_JPA_PU_2");
//        if (result!=expResult) {
